...
/*	@Override
	...
	public void render(int mouseX, int mouseY, float partialTicks) {
		...
		this.font.drawString(strL, centerX-adjustLeft-2, centerY-10, 0xFFFFFF);
		this.font.drawString(strR, centerX-adjustLeft-2, centerY, 0xFFFFFF);
		this.font.drawString(strW, centerX-adjustLeft-2, centerY+10, 0xFFFFFF);
		this.font.drawString(strT, centerX+1, centerY-10, 0xFFFFFF);
		this.font.drawString(strB, centerX+1, centerY, 0xFFFFFF);
		this.font.drawString(strH, centerX+1, centerY+10, 0xFFFFFF);
			...
			for(int i=0; i<=string.length()-1; i++) {
				...
				if(token == "x".charAt(0)) {
					GuiUtils.drawTexturedModalRect(this.x+left+i*5, this.y+top,
							ModeGuiSetting.charX+5*10, ModeGuiSetting.charY+disable, 5, 5, 20);
				}
				else if(token == "/".charAt(0)) {
					GuiUtils.drawTexturedModalRect(this.x+left+i*5, this.y+top,
							ModeGuiSetting.charX+5*11, ModeGuiSetting.charY+disable, 5, 5, 20);
				}
				else {
					GuiUtils.drawTexturedModalRect(this.x+left+i*5, this.y+top,
							ModeGuiSetting.charX+5*Integer.parseInt(""+token), ModeGuiSetting.charY+disable, 5, 5, 20);
				}
			}
	...
	private class GridSetButton extends SettingButton {
		...
		public void renderButton(int mouseX, int mouseY, float partialTicks) {
			...
			GuiUtils.drawTexturedModalRect(this.x, this.y,
					this.textureX, this.option.value()*16 + this.textureY, this.width, this.height, 20);
