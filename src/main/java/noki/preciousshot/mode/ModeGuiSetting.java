...
public class ModeGuiSetting extends GuiScreen {
	...
	public void initGui() {
		...
		this.buttonList.add(new FrameSetButton(31,198+x,	18+y,	52,	7,	160,0,	OTHER,	0, 0, "", "", PreciousShotConf.frameSet1));
		this.buttonList.add(new FrameSetButton(32,198+x,	27+y,	52,	7,	160,0,	OTHER,	0, 0, "", "", PreciousShotConf.frameSet2));
		this.buttonList.add(new FrameSetButton(33,252+x,	18+y,	52,	7,	160,0,	OTHER,	0, 0, "", "", PreciousShotConf.frameSet3));
		this.buttonList.add(new FrameSetButton(34,252+x,	27+y,	52,	7,	160,0,	OTHER,	0, 0, "", "", PreciousShotConf.frameSet4));
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		int adjustLeft = Math.max(this.fontRenderer.getStringWidth(strL), this.fontRenderer.getStringWidth(strR));
		adjustLeft = Math.max(adjustLeft, this.fontRenderer.getStringWidth(strW));
		this.fontRenderer.drawString(strL, centerX-adjustLeft-2, centerY-10, 0xFFFFFF);
		this.fontRenderer.drawString(strR, centerX-adjustLeft-2, centerY, 0xFFFFFF);
		this.fontRenderer.drawString(strW, centerX-adjustLeft-2, centerY+10, 0xFFFFFF);
		this.fontRenderer.drawString(strT, centerX+1, centerY-10, 0xFFFFFF);
		this.fontRenderer.drawString(strB, centerX+1, centerY, 0xFFFFFF);
		this.fontRenderer.drawString(strH, centerX+1, centerY+10, 0xFFFFFF);
	...
	protected void keyTyped(char typedChar, int keyCode) throws IOException {
		...
		if(keyCode == 1 || keyCode == PreciousShotConf.keyNum) {
	...
	private class WithStrButton extends SettingButton {
		...
		protected void drawStringFromTexture(String string) {			
			...
			for(int i=0; i<=string.length()-1; i++) {
				...
				if(token == "x".charAt(0)) {
					this.drawTexturedModalRect(this.x+left+i*5, this.y+top,
